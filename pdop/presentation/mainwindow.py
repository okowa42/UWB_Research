...
class MainWindow(QMainWindow):
    ...
    def __init__(self, gdop_app):
        ...
        self._trilat_plot = presentation.TrilatPlot3D(self, self._scenario)
        ...
        plot_layout.addWidget(self.trilat_canvas)

        self.trilat_toolbar = NavigationToolbar(self.trilat_canvas, self)
        plot_layout.addWidget(self.trilat_toolbar)
        # --------------------------------------------
        ...
        horizontal_splitter.addWidget(plot_widget)
